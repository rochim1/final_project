                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="slider_text">
                            ...
                            <p>Kami peduli dengan hewan peliharaan anda<br> percayakan kami merawat peliharaan anda.</p>
                            <a href="index.php?halaman=contact" class="boxed-btn4">Hubungi Kami</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pet_info">
                        <div class="section_title">
                            <h3><span>We care your pet </span> <br>
                                As you care</h3>
                            <p>Kalau kalian peduli dengan hewan peliharaan <br> tunjukkan betapa pedulinya kalian dengan hewan peliharaan kalian sendiri. <br>  <br></p>
                            <a href="index.php?halaman=about" class="boxed-btn3">About Us</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="contact_text text-center">
                        ...
                        <div class="contact_btn d-flex align-items-center justify-content-center">
                            <a href="index.php?halaman=contact" class="boxed-btn4">Contact Us</a>
                            <p>Or  <a href="#"> +6282 1544 4111 9</a></p>
                        </div>
                    </div>
                </div>
            </div>
