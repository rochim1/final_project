					...
					<div class="tab-pane active" id="tab1">
						<div class="container-fluid">
							<main class="page-content">
								<div class="card">
									<div class="content">
										<h2 class="title">Grooming Kutu</h2>
										<p class="copy">lorem penjelasa</p><button class="btn btn-primary">Get Service</button></div>
								</div>
								<div class="card">
									<div class="content">
										<h2 class="title">Pet Spa</h2>
										<p class="copy">penjelasan</p><button class="btn btn-primary">Get Service</button></div>
								</div>
								<div class="card">
									<div class="content">
										<h2 class="title">Grooming jamur</h2>
										<p class="copy">penjelasan signkat</p><button class="btn btn-primary">Get Service</button></div>
								</div>
								<div class="card">
									<div class="content">
										<h2 class="title">Grooming Lengkap</h2>
										<p class="copy">penjelasan signkat</p><button class="btn btn-primary">Get Service</button></div>
								</div>
							</main>	
						</div>
