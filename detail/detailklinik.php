...
<div class="container">
				...
				<div class="order-details-container">
					...
					<div class="odc-wrapper">
						...
						<div class="product-container">
							<ul class="list-group">
  <li class="list-group-item active">07:00-09:00 Dr simanta</li>
  <li class="list-group-item ">07:00-09:00 Dr simanta</li>
  <li class="list-group-item ">07:00-09:00 Dr simanta</li>
  <li class="list-group-item ">07:00-09:00 Dr simanta</li>
</ul>
						</div>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>Lainnya</option>
										...
										<div class="input-group-sm mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text" id="inputGroup-sizing-default">Vaksin</span>
											</div>
