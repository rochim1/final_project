<link rel="stylesheet" href="css/detailservice.css">
      ...
      <li></li>      
		...
		<div class="col-md-7">
			<div class="card w-100">
				<div class="card-header">Healty Meals</div>
				<div class="p-3">
					<p>
                        kami menyediakan layanan Grooming yang sudah tersebar diberbagai wilayah , sehingga pet lovers dapat memilih layanan terdekat dan sesuai dengan keingingan pet lovers
                    </p>
					...
					<div>	
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="home-tab" data-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true">deskripsi</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="profile-tab" data-toggle="tab" href="#detail" role="tab" aria-controls="detail" aria-selected="false">Detail</a>
							</li>
						</ul>

						<!-- Tab panes -->
						<div class="tab-content p-3 ">
							<div class="tab-pane active" id="description" role="tabpanel" aria-labelledby="description-tab">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Mollitia dolorem aliquid magnam praesentium, dolor sequi at accusantium provident explicabo debitis, deserunt dicta quod porro! Qui ipsum odit modi atque tempore.</div>
							<div class="tab-pane" id="detail" role="tabpanel" aria-labelledby="detail-tab">detail</div>
						</div>
					</div>
				</div>
            <hr>
            <div class="p-3">
                ...
                <button class="btn btn-success">join as mitra</button>
            </div>
        </div>
...
<script>
    // For some unknown reasons long minified code here totally breaks CodePen and can't be arsed to upload the javascript somewhere. So here's the full source of dragdealer.
